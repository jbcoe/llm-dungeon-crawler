...
- Healing Salve: A small tin containing a pungent, green paste that closes minor wounds. : healing
- Rusty Broadsword: A heavy blade, dulled by time and neglect, but still capable of crushing armor. : weapon
...
- Torn Scroll of Fireball: A brittle parchment with scorch marks along the edges. The runes are mostly intact. : weapon
...
- Obsidian Dagger: A wicked-looking blade chipped from volcanic glass. Exceptionally sharp but brittle. : weapon
- Minor Stamina Potion: A bubbling red concoction that restores energy and focus in combat. : healing
...
- Elven Bread: A small, wrapped wafer that is surprisingly filling and doesn't spoil. : healing
- Mysterious Amulet: A heavy gold pendant with an unblinking, red gemstone eye.
- Throwing Knives: A set of three well-balanced blades designed for throwing. : weapon
- Vial of Holy Water: Blessed water that burns undead flesh like acid. : weapon
...
- Sunfire Blade: A sword that glows with the intensity of a summer noon, dealing extra fire damage. : weapon
- Frostbrand Axe: A heavy axe covered in eternal frost, freezing enemies on hit. : weapon
- Shadow-Stitched Dagger: A blade that seems to disappear in shadows, bypassing physical armor. : weapon
- Stormbreaker Hammer: A massive warhammer that crackles with lightning and thunder. : weapon
- Dragon-Scale Mail: Armor forged from the scales of a red dragon, offering immense protection.
- Elven Longbow: A masterfully crafted bow that fires arrows with incredible speed and accuracy. : weapon
- Soul-Eating Scythe: A dark weapon that drains the life force of those it strikes. : weapon
- Phoenix Feather Wand: A wand that can unleash powerful bursts of fire. : weapon
...
- Ring of Regeneration: A gold band that slowly heals the wearer's wounds over time. : healing
...
- Vorpal Sword: A legendary blade that can decapitate even the most powerful foes with a single stroke. : weapon
- Holy Avenger: A paladin's sword that glows with divine light, dealing extra damage to undead and demons. : weapon
- Staff of the Archmagi: A powerful staff that contains a vast array of magical spells. : weapon
- Deck of Many Things: A deck of magical cards, each with a unique and unpredictable effect.
- Sphere of Annihilation: A black void that disintegrates anything it touches. : weapon
